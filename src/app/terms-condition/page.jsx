    ...
    <div>
      <div class="mainContainer justify-center text-gray-800 body-font overflow-hidden min-h-screen ">
        <div className="lg:mx-20 mx-6 py-28">
          <h1 className="text-5xl font-bold font-poppins mb-10 text-black ">
            TERMS AND CONDITIONS
          </h1>

          <div class="py-10 px-3 lg:px-10 rounded-lg m-2 lg:m-10 bg-[#f1fffe]">
            <br />
            <h1 className="text-3xl font-heading py-3">Introduction</h1>

            <ol>
              <ul className="px-10">
                <li>
                  These terms and conditions apply between you, the User of this
                  Website (including any sub-domains, unless expressly excluded
                  by their own terms and conditions), and Infolatch Ltd,  the
                  owner and operator of this Website. Please read these terms
                  and conditions carefully, as they affect your legal rights.
                ...
                <li>
                  ...
                  by  Infolatch Ltd and acting in the course of their employment
                  or (ii) engaged as a consultant or otherwise providing
                  services to  Infolatch Ltd and accessing the Website in
              ...
              <ul className="px-10">
                <li>
                  ...
                  is the property of  Infolatch Ltd,  our affiliates or other
                  ...
                  mark displayed on the site without the owner&apos;s prior
                  written permission{" "}
                </li>{" "}
                <br />
                <li>
                ...
                <li>
                  ...
                  permission of Infolatch Ltd.{" "}
                </li>{" "}
                <br />
              </ul>

              <br />
              <h1 className=" text-3xl font-heading py-3">Prohibited Use</h1>
              <br />
              ...
              <ul className="px-10">
                <li>
                  ...
                  expressly stated, these sites are not under the control
                  of Infolatch Ltd  or that of our affiliates.{" "}
                </li>{" "}
                <br />
                <li>
              ...
              <ul className="px-10">
                <li>
                  ...
                  and 
                  <Link className=" underline text-forth" href="/cookies">
                    Cookies
                  </Link>
                </li>{" "}
                {/* <Link className=" underline text-forth" href="www.infolatch.uk">www.infolatch.uk</Link>        */}
              </ul>
              <br />
              <h1 className=" text-3xl font-heading py-3">
              ...
              <ul className="px-10">
                <li>
                  ...
                  Infolatch Ltd makes available through the Website (the
                  Service) is provided as is and on an as available basis. We
                  give no warranty that the Service will be free of defects
                  ...
                  satisfactory quality. Infolatch Ltd is under no obligation to
                  update information on the Website.
                </li>{" "}
                <br />
                <li>
                  Whilst  Infolatch Ltd  uses reasonable endeavours to ensure
                  that the Website is secure and free of errors, viruses and
                  other malware, we give no warranty or guaranty in that regard
                  and all Users take responsibility for their own security, that
                  of their personal details and their computers.
                </li>{" "}
                <br />
                <li>
                   Infolatch Ltd accepts no liability for any disruption or
                  non-availability of the Website.
                </li>{" "}
                <br />
                <li>
                   Infolatch Ltd reserves the right to alter, suspend or
              ...
              <ul className="px-10">
                ...
                <br />
                <li>
                  To the maximum extent permitted by law, Infolatch Ltd accepts
                  no liability for any of the following:
                </li>{" "}
                <br />
                <li>
              ...
              <br />
              <h1 className=" text-3xl font-heading py-3">
                 Infolatch Ltd Details
              </h1>
              <br />
              <ul className="px-10">
                <li>
                  ⦁ Infolatch Ltd is a company incorporated in England and
                  Wales with registered number 14763673 whose registered address
                  is Suite 4787, Unit 3A 34-35, Hatton Garden
                  Holborn, London, EC1N 8DX and it operates the Website 
                  <Link
                    className=" underline text-forth"
                    href="/privacy-policy"
                  >
                  ...
                  .  The registered VAT number is 452688757. 
                </li>{" "}
                <br />
                <li>
                  You can contact Infolatch Ltd by email on
