...
export default function MegaDropDownIndustries({onCLick}){
  const fintechItems =[
   ...
   { id:3,to: '/industries/Edtech', name: "School Management Software" },
    ...
    return(
        <>
         <div
         onClick={onCLick}
          className='absolute lg:min-h-[900px] min-h-screen font-poppins  mx-auto overflow-hidden right-0 left-0   w-full bg-white shadow-lg py-10 lg:px-20 p-6 items-start  flex'>
